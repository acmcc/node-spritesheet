...
Style = (function() {
  ...
  Style.prototype.generate = function(options) {
    var attr, css, image, imagePath, images, pixelRatio, relativeImagePath, spriteHeight, spriteWidth, styles, _i, _len;
    ...
    if (this.pixelRatio < 2) {
      ...
      spriteHeight = options.layout.height / this.pixelRatio;
      spriteWidth = options.layout.width / this.pixelRatio;
